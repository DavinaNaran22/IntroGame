...
public class CaveScene : MonoBehaviour
{
    ...
    private List<string> additionalDialogues = new List<string>
    {
        ...
        "ALIEN: I knew it was powerful, but I didn't know what it was for. I thought it was the only way to kill him.",
        "ALIEN: So that's why I left those clues around, hoping if one day a visitor landed on Xenos, they will eventually find the cave and kill him.",
        "ALIEN: Now you can help by killing him to save us.",
        "YOU: That's what those clues were! The maze at the back was incorrect though...",
        "YOU: But how can I fight him? I don't have many weapons. I only have a pocket knife and a gun with very few bullets.",
