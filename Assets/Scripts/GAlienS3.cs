...
public class GAlienS3 : FindPlayerTransform
{
    ...
    {
        enterAlienArea4.isPlayerNearby = true;
        enterAlienArea4.StartAdditionalDialogues();
        ...
        while (enterAlienArea4 != null && enterAlienArea4.IsDialogueActive())
        {
            yield return null;
        }
    ...
    private IEnumerator DelayedBlockAppearance()
    {
        ...
        dropStone.SetActive(true); // Make the stone visible
