...
public class Clue_drag3 : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        inputActions.Player.Mouse_Down.performed += _ => Mouse_Down3();
        inputActions.Player.Mouse_Up.performed += _ => Mouse_Up3();
    }
