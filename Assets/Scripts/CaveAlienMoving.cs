...
public class CaveAlienMoving : FindPlayerTransform
{
    ...
    public float obstacleDetectionDistance = 1.5f; // Distance to detect obstacles
    public string obstacleTag = "RockWall";
